    ...
    <div className="min-h-screen">
      ...
      <section className="container py-14 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="font-display text-3xl md:text-5xl leading-tight text-ink-900 reveal-y reveal-delay" style={{"--delay":"0ms"}}>
              Schedule smarter. Teach better.
            </h2>
            <p className="mt-4 text-ink-600 text-base md:text-lg reveal-y reveal-delay" style={{"--delay":"80ms"}}>
              OptiClass generates optimized class timetables for your batches and phases—
              fast, conflict-free, and easy to share.
            </p>
            <div className="mt-6 flex flex-wrap gap-3">
              <button className="btn-primary hover-lift reveal-y reveal-delay" style={{"--delay":"140ms"}} onClick={() => navigate('/app')}>Get Started</button>
              <a className="btn-ghost hover-lift reveal-y reveal-delay" style={{"--delay":"180ms"}} href="#features">Learn more</a>
            </div>
          </div>
          <div className="card p-6 shadow-card reveal-x hover-lift" style={{"--delay":"220ms"}}>
            <div className="space-y-3">
              <div className="flex items-center gap-3 reveal-y reveal-delay" style={{"--delay":"0ms"}}>
                <div className="h-8 w-8 rounded-full bg-brand-100 text-brand-700 grid place-items-center float-slow">1</div>
                <div>
              ...
              <div className="flex items-center gap-3 reveal-y reveal-delay" style={{"--delay":"80ms"}}>
                <div className="h-8 w-8 rounded-full bg-brand-100 text-brand-700 grid place-items-center float-slow" style={{animationDelay: '400ms'}}>2</div>
                <div>
                  <div className="font-medium">Add subjects & credits</div>
                  <div className="text-sm text-ink-600">We optimize around your load.</div>
                </div>
              </div>
              <div className="flex items-center gap-3 reveal-y reveal-delay" style={{"--delay":"160ms"}}>
                <div className="h-8 w-8 rounded-full bg-brand-100 text-brand-700 grid place-items-center float-slow" style={{animationDelay: '800ms'}}>3</div>
                <div>
      ...
      <section id="features" className="container pb-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[{
            ...
            <div key={i} className="card p-5 hover-lift reveal-y reveal-delay" style={{"--delay": `${i*100}ms`}}>
      ...
      <section className="container pb-20">
        <div className="card p-6 flex flex-col md:flex-row items-center justify-between gap-4 reveal-y hover-lift">
          ...
          <button className="btn-primary hover-lift" onClick={() => navigate('/app')}>Open Scheduler</button>
        </div>
      </section>
    </div>
  );
